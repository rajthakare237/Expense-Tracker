...
class YearlyExpenseChart : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_yearly_expense_chart)

        materialToolbar = findViewById(R.id.yearExpToolbarCharts)
        ...
        anyChartView = findViewById(R.id.chartViewYearExp)
    ...
    // function to show pie chart for yearly expenses
