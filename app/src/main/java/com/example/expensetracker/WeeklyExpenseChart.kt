...
class WeeklyExpenseChart : AppCompatActivity() {
...
//    lateinit var barGraph: AnyChartView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_weekly_expense_chart)

        materialToolbar = findViewById(R.id.weekExpToolbarCharts)
        ...
        anyChartView = findViewById(R.id.chartViewWeekExp)

//        barGraph = findViewById(R.id.barGraphWeekExp)
...
//    }
    ...
    // function to show pie chart for weekly expenses
